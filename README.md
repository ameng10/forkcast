...
Each concept lives under `src/concepts/<ConceptName>/`. Common files in a concept folder:

- `<ConceptName>Specification.md` — specification (markdown)
- `<ConceptName>Concept.ts` — implementation (TypeScript)
- `<ConceptName>Concept.test.ts` — tests (TypeScript/Deno)
- `<ConceptName>ConsoleOutput.md` — recorded test console output (markdown)
- `<ConceptName>Changes.md` — design notes and changes (markdown)

Direct links (repo-root relative):

SwapSuggestions:
[@SwapSuggestionsSpecification](/src/concepts/SwapSuggestions/SwapSuggestionsSpecification.md)
[@SwapSuggestionsImplementation](/src/concepts/SwapSuggestions/SwapSuggestionsConcept.ts)
[@SwapSuggestionsTests](/src/concepts/SwapSuggestions/SwapSuggestionsConcept.test.ts)
[@SwapSuggestionsConsoleOutput](/src/concepts/SwapSuggestions/SwapSuggestionsConsoleOutput.md)
[@SwapSuggestionsChanges](/src/concepts/SwapSuggestions/SwapSuggestionsChanges.md)

MealLog:
[@MealLogSpecification](/src/concepts/MealLog/MealLogSpecification.md)
[@MealLogImplementation](/src/concepts/MealLog/MealLogConcept.ts)
[@MealLogTests](/src/concepts/MealLog/MealLogConcept.test.ts)
[@MealLogConsoleOutput](/src/concepts/MealLog/MealLogConsoleOutput.md)
[@MealLogChanges](/src/concepts/MealLog/MealLogChanges.md)

QuickCheckIns:
[@QuickCheckInsSpecification](/src/concepts/QuickCheckIns/QuickCheckInsSpecification.md)
[@QuickCheckInsImplementation](/src/concepts/QuickCheckIns/QuickCheckInsConcept.ts)
[@QuickCheckInsTests](/src/concepts/QuickCheckIns/QuickCheckInsConcept.test.ts)
[@QuickCheckInsConsoleOutput](/src/concepts/QuickCheckIns/QuickCheckInsConsoleOutput.md)
[@QuickCheckInsChanges](/src/concepts/QuickCheckIns/QuickCheckInsChanges.md)

InsightMining:
[@InsightMiningSpecification](/src/concepts/InsightMining/InsightMiningSpecification.md)
[@InsightMiningImplementation](/src/concepts/InsightMining/InsightMiningConcept.ts)
[@InsightMiningTests](/src/concepts/InsightMining/InsightMiningConcept.test.ts)
[@InsightMiningConsoleOutput](/src/concepts/InsightMining/InsightMiningConsoleOutput.md)
[@InsightMiningChanges](/src/concepts/InsightMining/InsightMiningChanges.md)

PersonalQA:
[@PersonalQASpecification](/src/concepts/PersonalQA/PersonalQASpecification.md)
[@PersonalQAImplementation](/src/concepts/PersonalQA/PersonalQAConcept.ts)
[@PersonalQATests](/src/concepts/PersonalQA/PersonalQAConcept.test.ts)
[@PersonalQAConsoleOutput](/src/concepts/PersonalQA/PersonalQAConsoleOutput.md)
[@PersonalQAChanges](/src/concepts/PersonalQA/PersonalQAChanges.md)
...
## Repository organization and example links

Below is a brief explanation of the repository structure and direct links to the `SwapSuggestions` concept artifacts (specification, implementation, tests, console output, and design/changes notes). Use these links to navigate between the spec, code, and test evidence.

- `design/concepts/SwapSuggestions/implementation.md` — concept design and implementation notes (spec-style document in markdown).
- `src/concepts/SwapSuggestions/SwapSuggestionsSpecification.md` — canonical specification (markdown, structured spec notation).
- `src/concepts/SwapSuggestions/SwapSuggestionsConcept.ts` — TypeScript implementation of the concept.
- `src/concepts/SwapSuggestions/SwapSuggestionsConcept.test.ts` — test script (Deno / TypeScript).
- `src/concepts/SwapSuggestions/SwapSuggestionsConsoleOutput.md` — a copy of the console output showing the execution of the test script (markdown).
- `src/concepts/SwapSuggestions/SwapSuggestionsChanges.md` — design notes and change log describing implementation differences, issues encountered, and fixes applied.

Quick navigation (repo-root relative links):
