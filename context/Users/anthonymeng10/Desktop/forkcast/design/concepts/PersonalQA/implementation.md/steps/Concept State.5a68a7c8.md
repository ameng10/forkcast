---
timestamp: 'Fri Nov 07 2025 01:09:17 GMT-0500 (Eastern Standard Time)'
parent: '[[../20251107_010917.faaf4c21.md]]'
content_id: 5a68a7c8cc297ce73fb3bb58b986bad8804d0485bf116380ef1ca1c7108ff57e
---
...
if (args.requester !== args.owner) return { error: "not\_owner" } as const;
const res = await this.facts.deleteOne({
\_id: args.factId,
owner: args.owner,
} as any);
if (res.deletedCount !== 1) return { error: "fact\_not\_found" } as const;
