...
content_id: 58d82e70cdddb4515995f7105baad33eafeb6528f286039cfb7e3d99b8a53dfb
---

# concept: UserAuthentication

This section provides the final specification for the `UserAuthentication` concept. The specification remains unchanged from the prompt, as the `logout` action is determined to belong to a separate `Sessioning` concept, as explained in the `problem`/`solution` sections below.
